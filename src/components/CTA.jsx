export default function CTA() {
  return (
    <section id="sustainability" className="relative py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="overflow-hidden rounded-[2rem] bg-gradient-to-br from-emerald-600 to-lime-600 p-8 sm:p-12 text-white shadow-2xl">
          <div className="grid gap-8 lg:grid-cols-3 lg:items-center">
            <div className="lg:col-span-2">
              <h3 className="text-2xl sm:text-4xl font-semibold tracking-tight">Sustainability without compromise</h3>
